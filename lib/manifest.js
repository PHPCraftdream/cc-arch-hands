...
export const AllCodexAgents = [
  ...
  { name: 'ls', model: 'sun', effort: 'low', display: 'Sun - low' },
  { name: 'ms', model: 'sun', effort: 'medium', display: 'Sun - medium' },
  { name: 'hs', model: 'sun', effort: 'high', display: 'Sun - high' },
  { name: 'xs', model: 'sun', effort: 'extra', display: 'Sun - extra' },
  { name: 'xxs', model: 'sun', effort: 'max', display: 'Sun - max' },
  { name: 'us', model: 'sun', effort: 'ultra', display: 'Sun - ultra' },
];
