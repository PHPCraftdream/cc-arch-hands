export const AllModelCommands = [
  ...
  // s1 — Sonnet 4.6 (previous top) — low medium high max (skips xhigh:
  // Sonnet 4.6 jumps straight from high to max in Claude Code's effort scale).
  { name: 's1l', model: 'claude-sonnet-4-6', effort: 'low', display: 'Sonnet 4.6 (200k) – low' },
  { name: 's1m', model: 'claude-sonnet-4-6', effort: 'medium', display: 'Sonnet 4.6 (200k) – medium' },
  { name: 's1h', model: 'claude-sonnet-4-6', effort: 'high', display: 'Sonnet 4.6 (200k) – high' },
  { name: 's1xx', model: 'claude-sonnet-4-6', effort: 'max', display: 'Sonnet 4.6 (200k) – max' },
  // s2 — Sonnet 4.5 — low medium high
  { name: 's2l', model: 'claude-sonnet-4-5', effort: 'low', display: 'Sonnet 4.5 (200k) – low' },
  { name: 's2m', model: 'claude-sonnet-4-5', effort: 'medium', display: 'Sonnet 4.5 (200k) – medium' },
  { name: 's2h', model: 'claude-sonnet-4-5', effort: 'high', display: 'Sonnet 4.5 (200k) – high' },
...
export const AllCodexAgents = [
  // Current Sol and Luna use the stable family aliases; previous releases use *1.
  { name: 'ls', model: 'gpt-6-sol', effort: 'low', display: 'Sol - low' },
  { name: 'ms', model: 'gpt-6-sol', effort: 'medium', display: 'Sol - medium' },
  { name: 'hs', model: 'gpt-6-sol', effort: 'high', display: 'Sol - high' },
  { name: 'xs', model: 'gpt-6-sol', effort: 'xhigh', display: 'Sol - Extra High' },
  { name: 'xxs', model: 'gpt-6-sol', effort: 'max', display: 'Sol - max' },
  ...
  { name: 'ul1', model: 'gpt-5.6-luna', effort: 'ultra', display: 'Luna 5.6 - ultra' },
  { name: 'ls1', model: 'gpt-5.6-sol', effort: 'low', display: 'Sol 5.6 - low' },
  { name: 'ms1', model: 'gpt-5.6-sol', effort: 'medium', display: 'Sol 5.6 - medium' },
  { name: 'hs1', model: 'gpt-5.6-sol', effort: 'high', display: 'Sol 5.6 - high' },
  { name: 'xs1', model: 'gpt-5.6-sol', effort: 'xhigh', display: 'Sol 5.6 - Extra High' },
  { name: 'xxs1', model: 'gpt-5.6-sol', effort: 'max', display: 'Sol 5.6 - max' },
  { name: 'us1', model: 'gpt-5.6-sol', effort: 'ultra', display: 'Sol 5.6 - ultra' },
