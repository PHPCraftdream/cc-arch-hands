...
export const AllCodexAgents = [
  ...
  { name: 'lt', model: 'terra', effort: 'low', display: 'Terra - low' },
  { name: 'mt', model: 'terra', effort: 'medium', display: 'Terra - medium' },
  { name: 'ht', model: 'terra', effort: 'high', display: 'Terra - high' },
  { name: 'xt', model: 'terra', effort: 'extra', display: 'Terra - extra' },
  { name: 'xxt', model: 'terra', effort: 'max', display: 'Terra - max' },
  { name: 'ut', model: 'terra', effort: 'ultra', display: 'Terra - ultra' },
  { name: 'll', model: 'luna', effort: 'low', display: 'Luna - low' },
  { name: 'ml', model: 'luna', effort: 'medium', display: 'Luna - medium' },
  { name: 'hl', model: 'luna', effort: 'high', display: 'Luna - high' },
  { name: 'xl', model: 'luna', effort: 'extra', display: 'Luna - extra' },
  { name: 'xxl', model: 'luna', effort: 'max', display: 'Luna - max' },
  { name: 'ul', model: 'luna', effort: 'ultra', display: 'Luna - ultra' },
  { name: 'ls', model: 'sol', effort: 'low', display: 'Sol - low' },
  { name: 'ms', model: 'sol', effort: 'medium', display: 'Sol - medium' },
  { name: 'hs', model: 'sol', effort: 'high', display: 'Sol - high' },
  { name: 'xs', model: 'sol', effort: 'extra', display: 'Sol - extra' },
  { name: 'xxs', model: 'sol', effort: 'max', display: 'Sol - max' },
  { name: 'us', model: 'sol', effort: 'ultra', display: 'Sol - ultra' },
];
