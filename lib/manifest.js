export const AllModelCommands = [
  ...
  // Haiku does not expose a Claude Code effort control. Keep the stable top
  // alias and the literal-version alias, but do not manufacture low/medium/
  // high commands that imply a capability the model does not have.
  { name: 'h', model: 'claude-haiku-4-5', effort: null, display: 'Haiku (top, 200k)' },
  { name: 'h45', model: 'claude-haiku-4-5', effort: null, display: 'Haiku 4.5 (200k)' },
];
