export const AllModelCommands = [
  ...
  // Sonnet (top) — claude-sonnet-4-6, low medium high (no xhigh, no max).
...
export let AllSkills = ['repo-sight', 'babysit', 'babygoal', 'task', 'checkpoint', 'checkpoint-prune', 'resume', 'triage'];
