export const AllModelCommands = [
  ...
  // Opus (top) — claude-opus-5, freshest opus family.
  { name: 'ol', model: 'claude-opus-5', effort: 'low', display: 'Opus (top, 1M) – low' },
  { name: 'om', model: 'claude-opus-5', effort: 'medium', display: 'Opus (top, 1M) – medium' },
  { name: 'oh', model: 'claude-opus-5', effort: 'high', display: 'Opus (top, 1M) – high' },
  { name: 'ox', model: 'claude-opus-5', effort: 'xhigh', display: 'Opus (top, 1M) – xhigh' },
  { name: 'oxx', model: 'claude-opus-5', effort: 'max', display: 'Opus (top, 1M) – max' },
  ...
  // o1 — Opus 4.8 (previous top)
  { name: 'o1l', model: 'claude-opus-4-8', effort: 'low', display: 'Opus 4.8 (1M) – low' },
  { name: 'o1m', model: 'claude-opus-4-8', effort: 'medium', display: 'Opus 4.8 (1M) – medium' },
  { name: 'o1h', model: 'claude-opus-4-8', effort: 'high', display: 'Opus 4.8 (1M) – high' },
  { name: 'o1x', model: 'claude-opus-4-8', effort: 'xhigh', display: 'Opus 4.8 (1M) – xhigh' },
  { name: 'o1xx', model: 'claude-opus-4-8', effort: 'max', display: 'Opus 4.8 (1M) – max' },
  // o2 — Opus 4.7
  { name: 'o2l', model: 'claude-opus-4-7', effort: 'low', display: 'Opus 4.7 (1M) – low' },
  { name: 'o2m', model: 'claude-opus-4-7', effort: 'medium', display: 'Opus 4.7 (1M) – medium' },
  { name: 'o2h', model: 'claude-opus-4-7', effort: 'high', display: 'Opus 4.7 (1M) – high' },
  { name: 'o2x', model: 'claude-opus-4-7', effort: 'xhigh', display: 'Opus 4.7 (1M) – xhigh' },
  { name: 'o2xx', model: 'claude-opus-4-7', effort: 'max', display: 'Opus 4.7 (1M) – max' },
  // o3 — Opus 4.6
  { name: 'o3l', model: 'claude-opus-4-6', effort: 'low', display: 'Opus 4.6 (1M) – low' },
  { name: 'o3m', model: 'claude-opus-4-6', effort: 'medium', display: 'Opus 4.6 (1M) – medium' },
  { name: 'o3h', model: 'claude-opus-4-6', effort: 'high', display: 'Opus 4.6 (1M) – high' },
  { name: 'o3x', model: 'claude-opus-4-6', effort: 'xhigh', display: 'Opus 4.6 (1M) – xhigh' },
  { name: 'o3xx', model: 'claude-opus-4-6', effort: 'max', display: 'Opus 4.6 (1M) – max' },
...
export const AllCodexAgents = [
  ...
  { name: 'xt', model: 'gpt-5.6-terra', effort: 'extra', display: 'Terra - extra' },
  { name: 'xxt', model: 'gpt-5.6-terra', effort: 'max', display: 'Terra - max' },
  { name: 'ut', model: 'gpt-5.6-terra', effort: 'ultra', display: 'Terra - ultra' },
  { name: 'll', model: 'gpt-5.6-luna', effort: 'low', display: 'Luna - low' },
  { name: 'ml', model: 'gpt-5.6-luna', effort: 'medium', display: 'Luna - medium' },
  { name: 'hl', model: 'gpt-5.6-luna', effort: 'high', display: 'Luna - high' },
  { name: 'xl', model: 'gpt-5.6-luna', effort: 'extra', display: 'Luna - extra' },
  { name: 'xxl', model: 'gpt-5.6-luna', effort: 'max', display: 'Luna - max' },
  { name: 'ul', model: 'gpt-5.6-luna', effort: 'ultra', display: 'Luna - ultra' },
  { name: 'ls', model: 'gpt-5.6-sol', effort: 'low', display: 'Sol - low' },
  { name: 'ms', model: 'gpt-5.6-sol', effort: 'medium', display: 'Sol - medium' },
  { name: 'hs', model: 'gpt-5.6-sol', effort: 'high', display: 'Sol - high' },
  { name: 'xs', model: 'gpt-5.6-sol', effort: 'extra', display: 'Sol - extra' },
  { name: 'xxs', model: 'gpt-5.6-sol', effort: 'max', display: 'Sol - max' },
  { name: 'us', model: 'gpt-5.6-sol', effort: 'ultra', display: 'Sol - ultra' },
];

export let AllSkills = ['repo-sight', 'babysit', 'babygoal', 'task', 'checkpoint', 'checkpoint-prune', 'resume', 'triage', 'checkpoint-watch', 'clock'];

// Opt-in only — the persistent sub-agent tree ("/agent-new" to create a node,
// "/agent" for everything after birth). Never part of the default `skills`
// class sweep; installed via `--agent-tree` or `--only agent-tree`. Kept out
// of AllSkills (and given its own sentinel in lib/sentinel.js) specifically
// so writeSkills'/removeSkills' AllSkills-scoped orphan-pruning never touches
// it. See lib/agent-tree.js.
export const AllAgentTreeSkills = ['agent', 'agent-new'];
