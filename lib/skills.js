...
export function writeSkills(templates, scope, options = {}) {
  ...
  for (const name of names) {
    ...
    mergeRecoveryMaintenance(recovery, preserved, root, destDir, options.recovery);
  ...
  const { pruned, preserved: prunedKept, recovery: prunedRecovery } = pruneOrphanDirs(
  ...
  return { written, skipped, pruned, preserved, recovery };
}
...
export function removeSkills(templates, scope, options = {}) {
  ...
  return { removed, skipped, preserved, recovery };
}
...
function mergeRecoveryMaintenance(recovery, preserved, root, path, options = undefined) {
