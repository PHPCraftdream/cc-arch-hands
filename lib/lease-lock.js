...
// Bounded retries for removing the fence after takeFence succeeded.
...
export function releaseLease(lease) {
  ...
  // release gets a fresh transient-error budget exactly like renew does.
  ...
  // One deadline covers the whole release: takeFence and every removal
  // attempt share it, so nested retry loops cannot multiply the stall.
