...
Usage:
  cah install   [--global|--local] [--cwd PATH] [--templates DIR] [--only SELECTOR] [--codex-agents] [--agent-tree]
  cah reinstall [--global|--local] [--cwd PATH] [--templates DIR] [--only SELECTOR] [--codex-agents] [--agent-tree]
  cah uninstall [--global|--local] [--cwd PATH] [--only SELECTOR] [--codex-agents] [--agent-tree]
...
// via their own --<flag> or explicit --only <class>.
const OPT_IN_FLAG_CLASSES = ['codex-agents', 'agent-tree'];
