...
export function writeFileAtomic(destPath, payload, options = {}) {
  ...
  try {
    ...
    assertOwnership(options);
    renameWithRetry(
      tmp, destPath, expectedDestination, tempSnapshot.expectedDestination.identity, options,
    );
    tmp = null;
...
function renameWithRetry(from, to, expectedDestination, sourceIdentity, options = {}) {
  let lastErr;
...
// Move a validated inode to a deterministic sibling before unlinking it.
