...
// locks and sidecars are the highest-volume producers and the marker claim
// namespaces follow. Producers outside the managed tree (`~/.claude/cah-bin.lock`,
...
const CACHE_SCAN_SUBDIRS = ['stamp-state', 'update-markers', 'hint-markers'];
