...
// The shared synchronous wait primitive for lease-lock.js and
// fs-atomic-publication.js retry loops: Atomics.wait on a throwaway
// SharedArrayBuffer-backed Int32Array blocks without spinning the CPU.
export function sleepSyncWait(ms) {
