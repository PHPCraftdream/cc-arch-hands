...
// Distinct sentinel (not SetForSkill) so the opt-in agent-tree skills are
// invisible to writeSkills'/removeSkills' AllSkills-scoped orphan-pruning —
// classifyContent sees a non-matching sentinel as foreign and leaves it
// alone. See lib/agent-tree.js.
export const SentinelAgentTree = '<!-- cah-agent-tree:v1 -->';
...
export const SetForAgentTree = {
  current: SentinelAgentTree,
  legacy: [],
};
